...
fun ComposeQuadrantApp() {
    // weight, is the property used to divide the blocks
    Column {
...
fun ComposeInfoCard(
    ...
    Column(
        /*
            It is important to use fillMaxSize to fill the entire line,
            otherwise only the content will have a colored background
        */
        modifier = modifier
            .fillMaxSize()
